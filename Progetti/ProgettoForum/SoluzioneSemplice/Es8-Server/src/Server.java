...
public class Server implements Runnable{
	/*************************
	 * Corpo del Thread principale, accetta connessioni e ne delega la gestione a dei thread figli,
	 * mantenendo il riferimento ai figli stessi per gli scambi di messaggi
	 * */
	...
	public synchronized boolean newMessage(String msg){
		//metodo per inviare un messaggio dal thread principale a TUTTI i thread figli 
